...
void RTCS_Run_Scheduler_EventTrigger(void); //use to observe event trigger with FSM implementation
void RTCS_Run_Scheduler_FSM(void); //use for fsm implementation without event trigger
